                                                                       ...
                                                                       public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                                           if (task.isSuccessful()) {
                                                                               if (task.getResult().exists()) {
                                                                                   ...
                                                                                   String giving_balance=task.getResult().getString("monthly_income");
                                                                                   String balance=scrond;
                                                                                   int total_p=Integer.parseInt(purches_balance)+Integer.parseInt(balance);
                                                                                                                                               ...
                                                                                                                                               if (task.getResult().exists()) {
                                                                                                                                                   ...
                                                                                                                                                   firebaseFirestore.collection("Daily_Collection")
                                                                                                                                                           ...
                                                                                                                                                           .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                                                               ...
                                                                                                                                                               public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                                                   if (task.isSuccessful()) {
                                                                                                                                                                     // int ttt = Integer.parseInt(packageprice)*10/100;;
                                                                                                                                                                       Calendar calendar = Calendar.getInstance();
                                                                                                                                                                       String current = DateFormat.getDateInstance(DateFormat.FULL).format(calendar.getTime());
                                                                                                                                                                       String current1 = DateFormat.getDateInstance().format(calendar.getTime());
                                                                                                                                                                       Random r = new Random();
                                                                                                                                                                       ...
                                                                                                                                                                       Long tsLong = System.currentTimeMillis()/1000;
                                                                                                                                                                       String ts = tsLong.toString();
                                                                                                                                                                       //Income income = new Income(refername, "Refer from " + username.getText().toString(), email,
                                                                                                                                                                               //String.valueOf(ttt), current1, ts,randomid,"0");
                                                                                                                                                                       Income2 income2=new Income2("Fund Receive","Fund Receive From Admin",name+"@gmail.com",balance,
                                                                                                                                                                               current,ts,randomid,"0");
                                                                                                                                                                       firebaseFirestore.collection("Fund_History")
                                                                                                                                                                               .document(name+"@gmail.com")
                                                                                                                                                                               .collection("List")
                                                                                                                                                                               .add(income2)
